...
namespace GameServer.Data
{
    ...
    public sealed class AccountData : GameData
    {
        ...
        public byte[] 角色列表描述()
        {
            ...
            ms.Seek(847 - 84, SeekOrigin.Begin);
            ...
            buffer = GamePacket.EncodeData(buffer);
            ms.Write(buffer);
        ...
        public void 账号登录(SConnection 当前网络, string 物理地址)
        {
            ...
            //当前网络.发送封包(new UnknownS1() { U1 = 100, U2 = 130, U3 = 160, U4 = 190, U5 = 220, U6 = 250, U7 = 250 });
            //当前网络.发送封包(new UnknownS2());
