...
namespace GameServer.Data
{
    ...
    public sealed class DataField
    {
        ...
        static DataField()
        {
            ...
            dictionary[typeof(DataMonitor<GameQuests>)] = delegate (BinaryReader r, GameData o, DataField f)
            {
                DataMonitor<GameQuests> DataMonitor = new DataMonitor<GameQuests>(o);
                DataMonitor.QuietlySetValue(GameQuests.DataSheet.TryGetValue(r.ReadInt32(), out var gameQuest) ? gameQuest : null);
                return DataMonitor;
            };
            dictionary[typeof(DataMonitor<GameQuestMission>)] = delegate (BinaryReader r, GameData o, DataField f)
            {
                DataMonitor<GameQuestMission> DataMonitor = new DataMonitor<GameQuestMission>(o);
            ...
            dictionary[typeof(HashMonitor<CharacterQuest>)] = delegate (BinaryReader r, GameData o, DataField f)
            {
                ...
                int num = r.ReadInt32();
                for (int i = 0; i < num; i++)
                    DataLinkTable.添加任务<CharacterQuest>(o, f, HashMonitor.ISet, r.ReadInt32());
                return HashMonitor;
            };
            dictionary[typeof(DataMonitor<CharacterQuest>)] = delegate (BinaryReader r, GameData o, DataField f)
            {
            ...
            {
                HashMonitor<CharacterQuestMission> HashMonitor = new HashMonitor<CharacterQuestMission>(o);
                int num = r.ReadInt32();
                for (int i = 0; i < num; i++)
                    DataLinkTable.添加任务<CharacterQuestMission>(o, f, HashMonitor.ISet, r.ReadInt32());
                return HashMonitor;
            };
