...
namespace UELib.Core
{
    ...
    public partial class UObject : object, IContainsTable, IBinaryData, IDisposable, IComparable
    {
        ...
        private void InitBuffer()
        {
            ...
            byte[] buff;
            var sourcePosition = (int)Package.Stream.Position;
            if (ExportTable != null)
            {
            ...
            _Buffer = new UObjectStream(Package.Stream, buff, sourcePosition);
        }
        ...
        protected void SerializeProperties(IUnrealStream stream)
        {
            if (Properties == null)
                return;
        ...
        {
            return string.Compare(Table.ClassName, className, StringComparison.OrdinalIgnoreCase) == 0;
        }
