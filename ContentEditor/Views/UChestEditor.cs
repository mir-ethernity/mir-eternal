...
{
    public partial class UChestEditor : UBaseEditor
    {
        public override string AttachedTabName => "TabChests";
        ...
        {
            InitializeComponent();
            DataGridChests.AutoGenerateColumns = false;
            DataGridChests.DataError += DataGridChests_DataError;
            DataGridChests.CellDoubleClick += DataGridChests_CellDoubleClick;
        }

        private void DataGridChests_CellDoubleClick(object? sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex < 0)
                return;

            var row = DataGridChests.Rows[e.RowIndex];
        ...
        private void DataGridChests_DataError(object? sender, DataGridViewDataErrorEventArgs e)
        {
        ...
        public override void ReloadDatabase(IDatabaseManager database)
        {
            ...
            DataGridChests.DataSource = database.Item.DataSource;
            DataGridChests.Refresh();
        }
