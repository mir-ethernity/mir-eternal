...
namespace GameServer.GMCommands
{
    public class Move : GMCommand
    {
        ...
        public override void Execute()
        {
            ...
            {
                SEnvir.AddCommandLog($"<= @Move Command execution failed, character {Character} does not exist");
                return;
            }
            ...
            if (player == null)
            {
                SEnvir.AddCommandLog($"<= @Move Command execution failed, player {Character} not connected");
                return;
            }
