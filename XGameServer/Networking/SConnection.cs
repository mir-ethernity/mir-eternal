...
namespace GameServer.Networking
{
    ...
    public sealed class SConnection
    {
        public SConnection(TcpClient tcpClient)
        {
            ...
            this.断开时间 = MainProcess.CurrentTime.AddMinutes((double)Config.DisconnectTime);
        ...
        private void ProcessReceivedPackets()
        {
            while (!this.ReceivedPackets.IsEmpty)
            {
                ...
                {
                    SEnvir.AddPacketLog(packet, true);
        ...
        private void 发送全部封包()
        {
            ...
            while (!SendPackets.IsEmpty)
            {
                ...
                {
                    SEnvir.AddPacketLog(packet, false);
